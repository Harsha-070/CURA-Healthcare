    ...
    <div className="flex-shrink-0 p-3 md:p-4 bg-transparent border-t border-slate-200 dark:border-slate-700/80">
      <div className="relative flex items-center">
        <input
          ...
          className="w-full h-12 px-6 pr-14 rounded-full bg-white/50 dark:bg-slate-800/50 border border-white/30 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-400 placeholder-slate-500 dark:placeholder-slate-400 text-slate-800 dark:text-slate-200 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
