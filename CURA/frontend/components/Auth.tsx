                ...
                <div className="p-8">
                    <div className="text-center mb-6">
                        <div className="inline-flex items-center justify-center gap-2 mb-2">
                             <BrandIcon className="w-10 h-10 text-sky-500 dark:text-sky-400" />
                            <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-100">CURA</h1>
                        </div>
                        <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm">Your personal healthcare assistant.</p>
